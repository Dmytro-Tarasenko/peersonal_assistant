from cls.AddressBook import AddressBook, Record, Address
import pickle

address_book = AddressBook()
rec_1 = Record('Bill', '25-12-1990')
# print(rec_1)
rec_1.add_edit_address(Address('Ukrane', '45125', 'Kyiv', 'Voli', '51', '150'))
# print(rec_1)
...
rec_2.add_edit_address(Address('Ukrane', 78956, 'Dnepr', 'Molody', '78', '25'))
...
rec_3.add_edit_address(Address('Ukraine', 95147, 'Dnepr', 'Soborna', '2', '50'))
address_book.add_record(rec_3)
rec_2 = Record('Noy', '05-02-1980', 'noy@gmail.com')
rec_2.add_edit_address(Address('Ukraine', 12345, 'Lviv', 'Voli', '205', '15'))
...
rec_5.add_edit_address(Address(country='Ukraine', zip_code=12345, city='Odesa', street='Voly', house= '10', apartment='5'))
rec_5.add_phone('4555552123')
address_book.add_record(rec_5)

rec_7 = Record('Ivan', '24-02-2020', 'okj@noi.gh')
rec_7.add_edit_address(Address(country='Ukraine', zip_code=78945, city='Fastov', street='Drugby', house= '140', apartment='54'))
rec_7.add_phone('45558743642')
address_book.add_record(rec_7)

rec_6 = Record('Jolly', '05-12-1950', 'j@ji.gh')
rec_6.add_edit_address(Address(country='USA', zip_code=58524, city='Orlean', street='New', house= '200', apartment='500'))
rec_6.add_phone('23232323568945')
address_book.add_record(rec_6)

rec_8 = Record('Mary', '25-12-1984', 'g@ni.gh')
rec_8.add_edit_address(Address(country='Poland', zip_code=45615, city='Lublin', street='Kurva', house= '6', apartment='45'))
rec_8.add_phone('44444445115')
address_book.add_record(rec_8)

rec_9 = Record('Oly', '25-12-2000', 'ghj@nji.gh')
rec_9.add_edit_address(Address(country='Ukraine', zip_code=85345, city='Odyn', street='Vody', house= '17', apartment='9'))
rec_9.add_phone('66212352123')
address_book.add_record(rec_9)

rec_10 = Record('Dan', '25-12-2000', 'ghj@nji.gh')
rec_10.add_edit_address(Address(country='Moldova', zip_code=58345, city='Kisiniv', street='Ukrainy', house= '62', apartment='1'))
rec_10.add_phone('2589631475')
address_book.add_record(rec_10)
address_book.print_address_book()

print(rec_1.search_str)
print(rec_2.search_str)
print(rec_3.search_str)
print(rec_4.search_str)
print(address_book.find_record(["%EMAIL%.joy"]))
